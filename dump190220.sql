...
CREATE TABLE `actors` (
  ...
  `film` varchar(50) NOT NULL DEFAULT 'film',
...
CREATE TABLE `connections` (
  `film_id` int(5) NOT NULL DEFAULT '1',
  `actor_id` int(5) NOT NULL DEFAULT '1',
  `producer_id` int(5) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-19 16:19:00
